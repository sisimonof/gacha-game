...
function renderFieldSlot(unit, slotIndex, side) {
  ...
  let statusIcons = '';
  if (unit.poisonDotTurns > 0) statusIcons += `<span class="bt-status-icon bt-status-poison" title="Poison (${unit.poisonDotTurns} tours)"><img src="/img/poison-badge.svg" class="bt-poison-img" alt="poison">${unit.poisonDotTurns}</span>`;
