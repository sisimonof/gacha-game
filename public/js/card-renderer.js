    ...
    <div class="battle-card ${shinyClass} ${fusedClass} ${tempClass} ${!unit.alive ? 'battle-card-ko' : ''}" style="border-color:${r.color}">
      ...
      <div class="battle-card-info">
        ...
        <div class="battle-statuses">
          ${unit.poisonDotTurns > 0 ? '<span title="Poison (' + unit.poisonDotTurns + ' tours)" class="bt-status-poison"><img src="/img/poison-badge.png" class="bt-poison-img" alt="poison">' + unit.poisonDotTurns + '</span>' : ''}
